...
const StarField: React.FC<{ paused?: boolean }> = ({ paused }) => {
...
const RetroSun: React.FC<{ paused?: boolean }> = ({ paused }) => {
...
const MovingGrid: React.FC<{ paused?: boolean }> = ({ paused }) => {
    const speed = useStore(state => state.speed);
...
export const Environment: React.FC = () => {
  ...
  return (
    <>
      ...
      <StarField paused={status === GameStatus.PAUSED} />
      <MovingGrid paused={status === GameStatus.PAUSED} />
      <LaneGuides />
      
      <RetroSun paused={status === GameStatus.PAUSED} />
    </>
  );
};
